...
.method constructor <init>(Landroid/support/v4/app/e;)V
    ...
    iget v0, p1, Landroid/support/v4/app/e;->y:I
    ...
    iget-object v0, p1, Landroid/support/v4/app/e;->A:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/n;->f:Ljava/lang/String;

    iget-boolean v0, p1, Landroid/support/v4/app/e;->D:Z
    ...
    iget-object v0, p1, Landroid/support/v4/app/e;->h:Landroid/os/Bundle;

    iput-object v0, p0, Landroid/support/v4/app/n;->i:Landroid/os/Bundle;

    iget-boolean p1, p1, Landroid/support/v4/app/e;->B:Z
...
.method public a(Landroid/support/v4/app/i;Landroid/support/v4/app/g;Landroid/support/v4/app/e;Landroid/support/v4/app/l;Landroid/arch/lifecycle/p;)Landroid/support/v4/app/e;
    ...
    iput-object v0, p2, Landroid/support/v4/app/e;->c:Landroid/os/Bundle;
    ...
    iput-boolean p3, p2, Landroid/support/v4/app/e;->n:Z

    const/4 p3, 0x1

    iput-boolean p3, p2, Landroid/support/v4/app/e;->p:Z

    iget p3, p0, Landroid/support/v4/app/n;->d:I

    iput p3, p2, Landroid/support/v4/app/e;->y:I

    iget p3, p0, Landroid/support/v4/app/n;->e:I

    iput p3, p2, Landroid/support/v4/app/e;->z:I
    ...
    iput-boolean p3, p2, Landroid/support/v4/app/e;->D:Z

    iget-boolean p3, p0, Landroid/support/v4/app/n;->h:Z

    iput-boolean p3, p2, Landroid/support/v4/app/e;->C:Z

    iget-boolean p3, p0, Landroid/support/v4/app/n;->j:Z

    iput-boolean p3, p2, Landroid/support/v4/app/e;->B:Z

    iget-object p1, p1, Landroid/support/v4/app/i;->b:Landroid/support/v4/app/k;

    iput-object p1, p2, Landroid/support/v4/app/e;->s:Landroid/support/v4/app/k;
    ...
    iput-object p4, p1, Landroid/support/v4/app/e;->v:Landroid/support/v4/app/l;

    iput-object p5, p1, Landroid/support/v4/app/e;->w:Landroid/arch/lifecycle/p;
