...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ag;->i:[I
    ...
    iput p1, p0, Landroid/support/v7/widget/ag;->a:F
    ...
    iget p1, p0, Landroid/support/v7/widget/ag;->b:I
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    iget v1, p0, Landroid/support/v7/widget/ag;->a:F

    invoke-static {v0, v4, p1, v1}, Landroid/support/v7/widget/ag;->a(Landroid/view/View;FFF)Z
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ag;->e:Ljava/lang/Runnable;

    if-nez p1, :cond_4

    new-instance p1, Landroid/support/v7/widget/ag$a;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/ag$a;-><init>(Landroid/support/v7/widget/ag;)V

    iput-object p1, p0, Landroid/support/v7/widget/ag;->e:Ljava/lang/Runnable;

    :cond_4
    iget-object p1, p0, Landroid/support/v7/widget/ag;->e:Ljava/lang/Runnable;

    iget v1, p0, Landroid/support/v7/widget/ag;->b:I

    int-to-long v3, v1

    invoke-virtual {v0, p1, v3, v4}, Landroid/view/View;->postDelayed(Ljava/lang/Runnable;J)Z

    iget-object p1, p0, Landroid/support/v7/widget/ag;->f:Ljava/lang/Runnable;

    if-nez p1, :cond_5

    new-instance p1, Landroid/support/v7/widget/ag$b;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/ag$b;-><init>(Landroid/support/v7/widget/ag;)V

    iput-object p1, p0, Landroid/support/v7/widget/ag;->f:Ljava/lang/Runnable;
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/ae;->isShown()Z
    ...
    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/ag;->b(Landroid/view/View;Landroid/view/MotionEvent;)Z

    invoke-direct {p0, v1, v3}, Landroid/support/v7/widget/ag;->a(Landroid/view/View;Landroid/view/MotionEvent;)Z

    iget v0, p0, Landroid/support/v7/widget/ag;->h:I

    invoke-virtual {v1, v3, v0}, Landroid/support/v7/widget/ae;->a(Landroid/view/MotionEvent;I)Z
...
.method d()V
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/ag;->g:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-boolean p1, p0, Landroid/support/v7/widget/ag;->g:Z
    ...
    :cond_4
    :goto_2
    iput-boolean p2, p0, Landroid/support/v7/widget/ag;->g:Z
...
.method public onViewDetachedFromWindow(Landroid/view/View;)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/ag;->g:Z
