...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/w;->c:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Landroid/support/v7/widget/w;->d:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/w;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/w;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/w;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/w;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p2, v1}, Landroid/support/v7/widget/ad;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/w;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/au;->e(I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/w;->c:Landroid/content/res/ColorStateList;
