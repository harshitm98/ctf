...
.field d:Landroid/support/v4/f/c;
...
.method a(I)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/ai;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ai;->g(I)V

    invoke-virtual {p1}, Landroid/support/v7/widget/ai;->a()V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v4/f/c;

    if-eqz v0, :cond_4

    invoke-virtual {v0, v1}, Landroid/support/v4/f/c;->a(Z)V

    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/ai;->e()Landroid/widget/ListView;
...
.method public setProvider(Landroid/support/v4/f/c;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v4/f/c;
