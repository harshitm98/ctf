...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    iput p4, p0, Landroid/support/v7/widget/av;->o:I

    iput p4, p0, Landroid/support/v7/widget/av;->p:I
    ...
    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/au;

    move-result-object p1

    sget v0, Landroid/support/v7/a/a$j;->ActionBar_homeAsUpIndicator:I

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/au;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->c(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/av;->j:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/av;->q:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_5

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->c(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/au;->a(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->c(I)V

    sget p2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/au;->g(II)I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/av;->a(Landroid/view/View;)V

    iget p2, p0, Landroid/support/v7/widget/av;->e:I
    ...
    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/au;->f(II)I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/av;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/au;->d(II)I

    move-result p2

    sget v1, Landroid/support/v7/a/a$j;->ActionBar_contentInsetEnd:I

    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/au;->d(II)I
    ...
    iget-object p4, p0, Landroid/support/v7/widget/av;->a:Landroid/support/v7/widget/Toolbar;
    ...
    iput p2, p0, Landroid/support/v7/widget/av;->e:I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/av;->a:Landroid/support/v7/widget/Toolbar;

    invoke-virtual {p1}, Landroid/support/v7/widget/Toolbar;->getNavigationContentDescription()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/av;->m:Ljava/lang/CharSequence;

    iget-object p1, p0, Landroid/support/v7/widget/av;->a:Landroid/support/v7/widget/Toolbar;

    new-instance p2, Landroid/support/v7/widget/av$1;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/av$1;-><init>(Landroid/support/v7/widget/av;)V
...
.method private t()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/av;->j:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/av;->q:Landroid/graphics/drawable/Drawable;
...
# virtual methods
.method public a(IJ)Landroid/support/v4/f/u;
    .locals 2
    ...
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/f/u;->a(J)Landroid/support/v4/f/u;

    move-result-object p2

    new-instance p3, Landroid/support/v7/widget/av$2;

    invoke-direct {p3, p0, p1}, Landroid/support/v7/widget/av$2;-><init>(Landroid/support/v7/widget/av;I)V

    invoke-virtual {p2, p3}, Landroid/support/v4/f/u;->a(Landroid/support/v4/f/v;)Landroid/support/v4/f/u;
...
.method public a(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/av;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/av;->n:Landroid/support/v7/widget/c;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/av;->n:Landroid/support/v7/widget/c;
...
.method public a(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/av;->g:Landroid/view/View;
...
.method public b(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/av;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public c(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/av;->l:Ljava/lang/CharSequence;
...
.method public e(I)V
    ...
    iget p1, p0, Landroid/support/v7/widget/av;->p:I

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/av;->f(I)V
...
.method public f(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/av;->d(Ljava/lang/CharSequence;)V
