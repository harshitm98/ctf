...
.field g:Landroid/support/v7/widget/an;
...
.field final p:Landroid/support/v4/f/v;

.field final q:Landroid/support/v4/f/v;

.field final r:Landroid/support/v4/f/x;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/l;->p:Landroid/support/v4/f/v;
    ...
    iput-object v0, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/f/v;
    ...
    iput-object v0, p0, Landroid/support/v7/app/l;->r:Landroid/support/v4/f/x;
...
.method private a(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/l;->b(Landroid/view/View;)Landroid/support/v7/widget/ac;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ac;
    ...
    iget-object p1, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ac;
...
.method private k(Z)V
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/an;)V

    iget-object p1, p0, Landroid/support/v7/app/l;->c:Landroid/support/v7/widget/ActionBarContainer;

    iget-object v0, p0, Landroid/support/v7/app/l;->g:Landroid/support/v7/widget/an;
    ...
    invoke-static {v0}, Landroid/support/v4/f/q;->g(Landroid/view/View;)V
    ...
    :cond_3
    :goto_2
    iget-object v0, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ac;
...
.method public a(II)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ac;
...
.method public h(Z)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/f/u;->b(F)Landroid/support/v4/f/u;

    move-result-object v2

    iget-object v3, p0, Landroid/support/v7/app/l;->r:Landroid/support/v4/f/x;

    invoke-virtual {v2, v3}, Landroid/support/v4/f/u;->a(Landroid/support/v4/f/x;)Landroid/support/v4/f/u;

    invoke-virtual {p1, v2}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/u;)Landroid/support/v7/view/h;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/u;->b(F)Landroid/support/v4/f/u;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/u;)Landroid/support/v7/view/h;
    ...
    iget-object v0, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/f/v;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/v;)Landroid/support/v7/view/h;
    ...
    :cond_5
    iget-object p1, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/f/v;
...
.method public i(Z)V
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/f/u;->b(F)Landroid/support/v4/f/u;

    move-result-object p1

    iget-object v1, p0, Landroid/support/v7/app/l;->r:Landroid/support/v4/f/x;

    invoke-virtual {p1, v1}, Landroid/support/v4/f/u;->a(Landroid/support/v4/f/x;)Landroid/support/v4/f/u;

    invoke-virtual {v0, p1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/u;)Landroid/support/v7/view/h;
    ...
    iget-object p1, p0, Landroid/support/v7/app/l;->p:Landroid/support/v4/f/v;

    invoke-virtual {v0, p1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/v;)Landroid/support/v7/view/h;
...
.method public j(Z)V
    ...
    invoke-interface {p1, v1, v4, v5}, Landroid/support/v7/widget/ac;->a(IJ)Landroid/support/v4/f/u;

    move-result-object p1

    iget-object v0, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v0, v3, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/f/u;
    ...
    invoke-interface {p1, v3, v6, v7}, Landroid/support/v7/widget/ac;->a(IJ)Landroid/support/v4/f/u;

    move-result-object v0

    iget-object p1, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {p1, v2, v4, v5}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/f/u;
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/f/u;Landroid/support/v4/f/u;)Landroid/support/v7/view/h;
    ...
    invoke-interface {p1, v1}, Landroid/support/v7/widget/ac;->d(I)V
    ...
    invoke-interface {p1, v3}, Landroid/support/v7/widget/ac;->d(I)V
