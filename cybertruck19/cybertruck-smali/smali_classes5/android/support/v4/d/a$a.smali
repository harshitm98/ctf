...
.method public constructor <init>(Landroid/text/PrecomputedText$Params;)V
    ...
    iput-object v0, p0, Landroid/support/v4/d/a$a;->b:Landroid/text/TextPaint;

    invoke-virtual {p1}, Landroid/text/PrecomputedText$Params;->getTextDirection()Landroid/text/TextDirectionHeuristic;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/d/a$a;->c:Landroid/text/TextDirectionHeuristic;

    invoke-virtual {p1}, Landroid/text/PrecomputedText$Params;->getBreakStrategy()I

    move-result v0

    iput v0, p0, Landroid/support/v4/d/a$a;->d:I

    invoke-virtual {p1}, Landroid/text/PrecomputedText$Params;->getHyphenationFrequency()I

    move-result v0

    iput v0, p0, Landroid/support/v4/d/a$a;->e:I

    iput-object p1, p0, Landroid/support/v4/d/a$a;->a:Landroid/text/PrecomputedText$Params;
...
.method constructor <init>(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v4/d/a$a;->a:Landroid/text/PrecomputedText$Params;

    iput-object p1, p0, Landroid/support/v4/d/a$a;->b:Landroid/text/TextPaint;

    iput-object p2, p0, Landroid/support/v4/d/a$a;->c:Landroid/text/TextDirectionHeuristic;

    iput p3, p0, Landroid/support/v4/d/a$a;->d:I

    iput p4, p0, Landroid/support/v4/d/a$a;->e:I
...
.method public a()Landroid/text/TextPaint;
    ...
    iget-object v0, p0, Landroid/support/v4/d/a$a;->b:Landroid/text/TextPaint;
...
.method public b()Landroid/text/TextDirectionHeuristic;
    ...
    iget-object v0, p0, Landroid/support/v4/d/a$a;->c:Landroid/text/TextDirectionHeuristic;
...
.method public c()I
    ...
    iget v0, p0, Landroid/support/v4/d/a$a;->d:I
...
.method public d()I
    ...
    iget v0, p0, Landroid/support/v4/d/a$a;->e:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v2, p1, Landroid/support/v4/d/a$a;
    ...
    :cond_1
    check-cast p1, Landroid/support/v4/d/a$a;

    iget-object v2, p0, Landroid/support/v4/d/a$a;->a:Landroid/text/PrecomputedText$Params;

    if-eqz v2, :cond_2

    iget-object p1, p1, Landroid/support/v4/d/a$a;->a:Landroid/text/PrecomputedText$Params;
    ...
    iget v2, p0, Landroid/support/v4/d/a$a;->d:I
    ...
    :cond_3
    iget v2, p0, Landroid/support/v4/d/a$a;->e:I
    ...
    iget-object v2, p0, Landroid/support/v4/d/a$a;->c:Landroid/text/TextDirectionHeuristic;
    ...
    :cond_5
    iget-object v2, p0, Landroid/support/v4/d/a$a;->b:Landroid/text/TextPaint;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Landroid/support/v4/d/a$a;->b:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Landroid/support/v4/d/a$a;->c:Landroid/text/TextDirectionHeuristic;

    aput-object v1, v0, v6

    iget v1, p0, Landroid/support/v4/d/a$a;->d:I
    ...
    iget v1, p0, Landroid/support/v4/d/a$a;->e:I
