...
.method public constructor <init>(Landroid/support/v4/app/k;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
...
.method private static b(Landroid/support/v4/app/c$a;)Z
    ...
    iget-object p0, p0, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/e;->X()Z
...
.method a(Ljava/util/ArrayList;Landroid/support/v4/app/e;)Landroid/support/v4/app/e;
    ...
    invoke-direct {v7, v11, v4}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/e;)V

    invoke-virtual {v6, v3, v7}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    add-int/lit8 v3, v3, 0x1

    iget-object v4, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    goto/16 :goto_4

    :cond_1
    iget-object v6, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
    ...
    iget-object v5, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    invoke-direct {v6, v11, v5}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/e;)V
    ...
    iget v9, v6, Landroid/support/v4/app/e;->z:I
    ...
    check-cast v14, Landroid/support/v4/app/e;

    iget v15, v14, Landroid/support/v4/app/e;->z:I
    ...
    invoke-direct {v15, v11, v14}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/e;)V
    ...
    invoke-direct {v15, v10, v14}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/e;)V
    ...
    :cond_8
    iget-object v2, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
...
.method a(I)V
    ...
    iget-object v4, v3, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    if-eqz v4, :cond_2

    iget-object v4, v3, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    iget v5, v4, Landroid/support/v4/app/e;->r:I

    add-int/2addr v5, p1

    iput v5, v4, Landroid/support/v4/app/e;->r:I
    ...
    iget-object v5, v3, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
    ...
    iget-object v3, v3, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    iget v3, v3, Landroid/support/v4/app/e;->r:I
...
.method a(Landroid/support/v4/app/e$c;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
...
.method public a(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    ...
    iget-object v3, v2, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
...
.method a(Z)V
    ...
    :pswitch_1
    iget-object v4, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
    ...
    iget-object v2, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
    ...
    iget-object p1, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
...
.method a(Ljava/util/ArrayList;II)Z
    ...
    iget-object v5, v4, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    if-eqz v5, :cond_1

    iget-object v4, v4, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    iget v4, v4, Landroid/support/v4/app/e;->z:I
    ...
    iget-object v9, v8, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    if-eqz v9, :cond_2

    iget-object v8, v8, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;

    iget v8, v8, Landroid/support/v4/app/e;->z:I
...
.method public a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    invoke-virtual {p1, p0}, Landroid/support/v4/app/k;->a(Landroid/support/v4/app/c;)V
...
.method b(Ljava/util/ArrayList;Landroid/support/v4/app/e;)Landroid/support/v4/app/e;
    ...
    :pswitch_0
    iget-object p2, v1, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/e;
...
.method b()V
    ...
    :pswitch_1
    iget-object v6, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
    ...
    iget-object v3, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/k;
...
.method b(I)Z
    ...
    iget v3, v3, Landroid/support/v4/app/e;->z:I
