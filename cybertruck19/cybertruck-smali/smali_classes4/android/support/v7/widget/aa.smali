...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/aa;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/aa;->c:I

    iput-boolean v0, p0, Landroid/support/v7/widget/aa;->d:Z

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, Landroid/support/v7/widget/aa;->e:F

    iput v1, p0, Landroid/support/v7/widget/aa;->f:F

    iput v1, p0, Landroid/support/v7/widget/aa;->g:F

    new-array v1, v0, [I

    iput-object v1, p0, Landroid/support/v7/widget/aa;->h:[I

    iput-boolean v0, p0, Landroid/support/v7/widget/aa;->i:Z

    iput-object p1, p0, Landroid/support/v7/widget/aa;->k:Landroid/widget/TextView;

    iget-object p1, p0, Landroid/support/v7/widget/aa;->k:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/aa;->l:Landroid/content/Context;
...
.method private a(Landroid/graphics/RectF;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aa;->h:[I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/aa;->h:[I
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/aa;->h:[I
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v0, v2, v1}, Landroid/support/v7/widget/aa;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v1, v3, v2}, Landroid/support/v7/widget/aa;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2, v4, v3}, Landroid/support/v7/widget/aa;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/aa;->j:Landroid/text/TextPaint;
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->j:Landroid/text/TextPaint;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/aa;->k:Landroid/widget/TextView;

    invoke-virtual {p2}, Landroid/widget/TextView;->getLineSpacingExtra()F

    move-result p2

    iget-object p3, p0, Landroid/support/v7/widget/aa;->k:Landroid/widget/TextView;
...
.method private a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {p0, p2}, Landroid/support/v7/widget/aa;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private a(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/aa;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v1, Landroid/support/v7/widget/aa;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private a(F)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/aa;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private a(FFF)V
    ...
    iput p1, p0, Landroid/support/v7/widget/aa;->f:F

    iput p2, p0, Landroid/support/v7/widget/aa;->g:F

    iput p3, p0, Landroid/support/v7/widget/aa;->e:F

    const/4 p1, 0x0

    iput-boolean p1, p0, Landroid/support/v7/widget/aa;->i:Z
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroid/support/v7/widget/aa;->a([I)[I

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/aa;->h:[I

    invoke-direct {p0}, Landroid/support/v7/widget/aa;->h()Z
...
.method private a(ILandroid/graphics/RectF;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/aa;->j:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/aa;->k:Landroid/widget/TextView;
    ...
    invoke-direct {p0, p1, v4, v2}, Landroid/support/v7/widget/aa;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, p1, v2, v1}, Landroid/support/v7/widget/aa;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v0, p1, v2}, Landroid/support/v7/widget/aa;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method private h()Z
    ...
    :goto_0
    iput-boolean v3, p0, Landroid/support/v7/widget/aa;->i:Z

    iget-boolean v3, p0, Landroid/support/v7/widget/aa;->i:Z

    if-eqz v3, :cond_1

    iput v2, p0, Landroid/support/v7/widget/aa;->c:I
...
.method private i()Z
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/aa;->k()Z
    ...
    :goto_0
    iget v4, p0, Landroid/support/v7/widget/aa;->e:F
    ...
    iget v4, p0, Landroid/support/v7/widget/aa;->f:F
    ...
    iget v5, p0, Landroid/support/v7/widget/aa;->e:F
    ...
    iput-object v0, p0, Landroid/support/v7/widget/aa;->h:[I

    :cond_3
    iput-boolean v2, p0, Landroid/support/v7/widget/aa;->d:Z
...
.method a(I)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/aa;->l:Landroid/content/Context;
    ...
    invoke-direct {p0, v0, p1, v1}, Landroid/support/v7/widget/aa;->a(FFF)V
...
.method a(IF)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/aa;->a(F)V
...
.method a(IIII)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/aa;->a(FFF)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Landroid/support/v7/widget/aa;->c:I
    ...
    invoke-direct {p0, v4}, Landroid/support/v7/widget/aa;->a(Landroid/content/res/TypedArray;)V
    ...
    iget-boolean p1, p0, Landroid/support/v7/widget/aa;->i:Z
    ...
    :cond_7
    invoke-direct {p0, v1, v3, p2}, Landroid/support/v7/widget/aa;->a(FFF)V
...
.method a([II)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/aa;->h:[I
...
.method d()I
    ...
    iget v0, p0, Landroid/support/v7/widget/aa;->g:F
...
.method f()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aa;->g()Z
    ...
    invoke-direct {p0, v0, v3, v2}, Landroid/support/v7/widget/aa;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    sget-object v4, Landroid/support/v7/widget/aa;->a:Landroid/graphics/RectF;
