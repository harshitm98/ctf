...
.method private c(II)V
    ...
    iget v9, v0, Landroid/support/v7/widget/ActionMenuView;->l:I
    ...
    iput-boolean v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->f:Z

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->c:I

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->b:I

    iput-boolean v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->d:Z

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$c;->rightMargin:I
    ...
    :goto_2
    iput-boolean v3, v9, Landroid/support/v7/widget/ActionMenuView$c;->e:Z

    iget-boolean v3, v9, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    iget-boolean v15, v9, Landroid/support/v7/widget/ActionMenuView$c;->d:Z
    ...
    :cond_5
    iget-boolean v9, v9, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    iget-boolean v10, v7, Landroid/support/v7/widget/ActionMenuView$c;->d:Z
    ...
    :cond_a
    iget v10, v7, Landroid/support/v7/widget/ActionMenuView$c;->b:I

    if-ge v10, v3, :cond_b

    iget v3, v7, Landroid/support/v7/widget/ActionMenuView$c;->b:I
    ...
    iget v9, v10, Landroid/support/v7/widget/ActionMenuView$c;->b:I
    ...
    iget-boolean v1, v10, Landroid/support/v7/widget/ActionMenuView$c;->e:Z
    ...
    :goto_b
    iget v1, v10, Landroid/support/v7/widget/ActionMenuView$c;->b:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, v10, Landroid/support/v7/widget/ActionMenuView$c;->b:I

    iput-boolean v2, v10, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    iput v9, v3, Landroid/support/v7/widget/ActionMenuView$c;->c:I

    const/4 v2, 0x1

    iput-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$c;->f:Z

    if-nez v1, :cond_1d

    iget-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$c;->e:Z
    ...
    iput v2, v3, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I
    ...
    iget-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    iput v7, v3, Landroid/support/v7/widget/ActionMenuView$c;->rightMargin:I
    ...
    iput v7, v3, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I
    ...
    iget-boolean v5, v3, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    :cond_24
    iget v5, v3, Landroid/support/v7/widget/ActionMenuView$c;->b:I
...
.method protected onMeasure(II)V
    ...
    iget v4, p0, Landroid/support/v7/widget/ActionMenuView;->j:I
