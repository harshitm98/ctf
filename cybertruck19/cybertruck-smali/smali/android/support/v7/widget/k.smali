...
.field private l:Landroid/support/v4/e/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/e/l<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/k$c;-><init>(I)V
    ...
    sput-object v2, Landroid/support/v7/widget/k;->d:[I
    ...
    sput-object v3, Landroid/support/v7/widget/k;->e:[I
    ...
    sput-object v3, Landroid/support/v7/widget/k;->f:[I
...
.method public static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :try_start_0
    sget-object v1, Landroid/support/v7/widget/k;->c:Landroid/support/v7/widget/k$c;

    invoke-virtual {v1, p0, p1}, Landroid/support/v7/widget/k$c;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v2, p0, p1, v1}, Landroid/support/v7/widget/k$c;->a(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
...
.method private static a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroid/support/v7/widget/k;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3, v0, v3}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p3, v0, v2}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/ap;->a(Landroid/content/Context;I)I

    move-result p1

    sget-object p3, Landroid/support/v7/widget/k;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p2, p1, p3}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/ap;->c(Landroid/content/Context;I)I
...
.method public static declared-synchronized a()Landroid/support/v7/widget/k;
    ...
    :try_start_0
    sget-object v1, Landroid/support/v7/widget/k;->b:Landroid/support/v7/widget/k;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/v7/widget/k;

    invoke-direct {v1}, Landroid/support/v7/widget/k;-><init>()V

    sput-object v1, Landroid/support/v7/widget/k;->b:Landroid/support/v7/widget/k;

    sget-object v1, Landroid/support/v7/widget/k;->b:Landroid/support/v7/widget/k;

    invoke-static {v1}, Landroid/support/v7/widget/k;->a(Landroid/support/v7/widget/k;)V
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/e/l;->c(ILjava/lang/Object;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;[I)V
    .locals 2
    ...
    iget-object p1, p1, Landroid/support/v7/widget/as;->b:Landroid/graphics/PorterDuff$Mode;

    goto :goto_2

    :cond_4
    sget-object p1, Landroid/support/v7/widget/k;->a:Landroid/graphics/PorterDuff$Mode;

    :goto_2
    invoke-static {v0, p1, p2}, Landroid/support/v7/widget/k;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method private static a(Landroid/support/v7/widget/k;)V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/k$e;-><init>()V

    const-string v1, "vector"

    invoke-direct {p0, v1, v0}, Landroid/support/v7/widget/k;->a(Ljava/lang/String;Landroid/support/v7/widget/k$d;)V

    new-instance v0, Landroid/support/v7/widget/k$b;

    invoke-direct {v0}, Landroid/support/v7/widget/k$b;-><init>()V
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/k$d;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/e/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v0, Landroid/support/v7/widget/k;->a:Landroid/graphics/PorterDuff$Mode;

    sget-object v1, Landroid/support/v7/widget/k;->d:[I

    invoke-static {v1, p1}, Landroid/support/v7/widget/k;->a([II)Z
    ...
    :cond_0
    sget-object v1, Landroid/support/v7/widget/k;->f:[I
    ...
    :cond_1
    sget-object v1, Landroid/support/v7/widget/k;->g:[I
    ...
    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/ap;->a(Landroid/content/Context;I)I

    move-result p0

    invoke-static {p0, v0}, Landroid/support/v7/widget/k;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/k;->m:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroid/support/v4/e/f;->b(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/k;->a(Landroid/util/TypedValue;)J

    move-result-wide v3

    invoke-direct {p0, p1, v3, v4}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v3, v4, v1}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/e/l;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Landroid/support/v4/e/l;->a(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/e/l;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/e/l;

    invoke-virtual {v8, p2, v3}, Landroid/support/v4/e/l;->c(ILjava/lang/Object;)V

    iget-object v8, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/e/a;

    invoke-virtual {v8, v3}, Landroid/support/v4/e/a;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/support/v7/widget/k$d;
    ...
    invoke-interface {v3, p1, v1, v7, v8}, Landroid/support/v7/widget/k$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v4, v5, v6}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/e/l;

    invoke-virtual {p1, p2, v2}, Landroid/support/v4/e/l;->c(ILjava/lang/Object;)V
...
.method private e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/ap;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/ap;->a:[I
    ...
    sget-object v5, Landroid/support/v7/widget/ap;->e:[I

    aput-object v5, v1, v4

    sget v5, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/ap;->a(Landroid/content/Context;I)I

    move-result p1

    aput p1, v0, v4

    sget-object p1, Landroid/support/v7/widget/ap;->h:[I
    ...
    :cond_0
    sget-object v2, Landroid/support/v7/widget/ap;->a:[I
    ...
    sget-object v2, Landroid/support/v7/widget/ap;->e:[I
    ...
    sget-object v2, Landroid/support/v7/widget/ap;->h:[I
...
.method private e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/e/l;->a(I)Ljava/lang/Object;
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/ap;->c(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroid/support/v7/widget/ap;->a:[I
    ...
    sget-object p1, Landroid/support/v7/widget/ap;->d:[I
    ...
    sget-object p1, Landroid/support/v7/widget/ap;->b:[I
...
.method private f(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/k;->o:Z
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/k;->f(Landroid/content/Context;)V
...
.method declared-synchronized a(Landroid/content/Context;Landroid/support/v7/widget/az;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    check-cast p1, Landroid/support/v4/e/f;
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/k;->e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
