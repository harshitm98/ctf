...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    :goto_0
    iput-object v3, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;
    ...
    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/au;->g(II)I
    ...
    :goto_1
    iput-object p5, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;

    :goto_2
    iget-object p5, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;
    ...
    :try_start_0
    sget-object p5, Landroid/support/v7/widget/x;->d:[I
    ...
    invoke-direct {p4, p0, p5, p2, p3}, Landroid/support/v7/widget/x$b;-><init>(Landroid/support/v7/widget/x;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object p5, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;

    sget-object v4, Landroid/support/v7/a/a$j;->Spinner:[I

    invoke-static {p5, p2, v4, p3, v1}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/au;
    ...
    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/au;->f(II)I
    ...
    invoke-virtual {p5, v1}, Landroid/support/v7/widget/au;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/x$b;->a(Landroid/graphics/drawable/Drawable;)V

    sget v1, Landroid/support/v7/a/a$j;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/au;->d(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/x$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroid/support/v7/widget/au;->a()V

    iput-object p4, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/x$b;

    new-instance p5, Landroid/support/v7/widget/x$1;

    invoke-direct {p5, p0, p0, p4}, Landroid/support/v7/widget/x$1;-><init>(Landroid/support/v7/widget/x;Landroid/view/View;Landroid/support/v7/widget/x$b;)V

    iput-object p5, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/ag;

    :cond_6
    sget p4, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/au;->f(I)[Ljava/lang/CharSequence;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->h:Landroid/widget/SpinnerAdapter;
