...
.field a:Landroid/support/v4/f/c;
...
.method private a(Landroid/view/MenuItem;)V
    ...
    :cond_9
    :goto_3
    iget-object v0, p0, Landroid/support/v7/view/g$b;->a:Landroid/support/v4/f/c;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Landroid/support/v4/f/h;->a(Landroid/view/MenuItem;Landroid/support/v4/f/c;)Landroid/view/MenuItem;

    :cond_a
    iget-object v0, p0, Landroid/support/v7/view/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/f/h;->a(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v7/view/g$b;->D:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/f/h;->b(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Landroid/support/v7/view/g$b;->p:C

    iget v1, p0, Landroid/support/v7/view/g$b;->q:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/f/h;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Landroid/support/v7/view/g$b;->r:C

    iget v1, p0, Landroid/support/v7/view/g$b;->s:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/f/h;->a(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Landroid/support/v7/view/g$b;->F:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_b

    invoke-static {p1, v0}, Landroid/support/v4/f/h;->a(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/f/h;->a(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public b(Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/g$b;->a:Landroid/support/v4/f/c;
    ...
    :cond_3
    iput-object v3, p0, Landroid/support/v7/view/g$b;->a:Landroid/support/v4/f/c;
    ...
    invoke-static {v0, v2}, Landroid/support/v7/widget/ad;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
