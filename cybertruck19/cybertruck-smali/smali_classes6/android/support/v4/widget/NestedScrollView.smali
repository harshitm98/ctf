...
# interfaces
.implements Landroid/support/v4/f/j;
...
.field private final y:Landroid/support/v4/f/n;

.field private final z:Landroid/support/v4/f/k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/f/n;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/f/n;

    new-instance p1, Landroid/support/v4/f/k;

    invoke-direct {p1, p0}, Landroid/support/v4/f/k;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/f/k;
    ...
    invoke-static {p0, p1}, Landroid/support/v4/f/q;->a(Landroid/view/View;Landroid/support/v4/f/b;)V
...
.method public a(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/f/k;

    invoke-virtual {v0, p1}, Landroid/support/v4/f/k;->b(I)V
...
.method public a(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/f/n;

    invoke-virtual {v0, p1, p2}, Landroid/support/v4/f/n;->a(Landroid/view/View;I)V
...
.method public a(II)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/f/k;->a(II)Z
...
.method public a(IIII[II)Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/f/k;->a(IIII[II)Z
...
.method public a(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/f/k;->a(II[I[II)Z
...
.method public final b(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/f/q;->a(Landroid/view/View;)V
...
.method public b(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/f/n;->a(Landroid/view/View;Landroid/view/View;II)V
...
.method public b(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/f/k;->a(I)Z
...
.method public computeScroll()V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/f/q;->a(Landroid/view/View;)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/f/k;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/f/k;->a(FF)Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/f/k;->a()Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v4, v0}, Landroid/support/v4/widget/NestedScrollView;->d(II)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v10, v1, v13}, Landroid/support/v4/widget/NestedScrollView;->a(II)Z
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/f/k;->a(Z)V
