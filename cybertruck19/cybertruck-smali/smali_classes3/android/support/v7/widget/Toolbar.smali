...
.field private u:Landroid/support/v7/widget/am;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/au;->g(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/au;->c(II)I
    ...
    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/au;->d(II)I

    move-result p2

    sget p3, Landroid/support/v7/a/a$j;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/au;->g(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Landroid/support/v7/widget/au;->d(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/au;->d(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/au;->e(II)I
    ...
    invoke-virtual {p1, v2, v0}, Landroid/support/v7/widget/au;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$j;->Toolbar_contentInsetLeft:I

    invoke-virtual {p1, v3, v1}, Landroid/support/v7/widget/au;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/a/a$j;->Toolbar_contentInsetRight:I

    invoke-virtual {p1, v4, v1}, Landroid/support/v7/widget/au;->e(II)I

    move-result v4

    invoke-direct {p0}, Landroid/support/v7/widget/Toolbar;->s()V

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/am;
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/am;

    invoke-virtual {v3, p2, v2}, Landroid/support/v7/widget/am;->a(II)V
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/au;->b(II)I
...
.method private a(Ljava/util/List;[I)I
    ...
    iget v3, v6, Landroid/support/v7/widget/Toolbar$b;->rightMargin:I
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p0}, Landroid/support/v4/f/q;->b(Landroid/view/View;)I
    ...
    invoke-static {p2, v4}, Landroid/support/v4/f/d;->a(II)I
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroid/support/v4/f/g;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    invoke-static {p1}, Landroid/support/v4/f/g;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private s()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/am;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/am;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/f/q;->c(Landroid/view/View;)I
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/widget/TextView;
